...
{       
        ...
        {
            $('#appointment-delivery > h4').after('<div id="relays-list"></div>')  ;
            $('#appointment-delivery > h4').after('<a id="jscart-relays" class="btn">'+lang.openBtn+'</a>')  ;
            ...
            $("a#jscart-relays").click(function(){
                ...
                {   /*first time*/
                        ...
                        $("#relays-list").show();
                        $("#appointment-details").slideUp();
                        $("#appointment-cart").hide();
                        $("a#jscart-relays").hide();
...
function selectRelay(r)
{
    ...
    {
        $('#appointment-button-wrapper').append('<input type="hidden" name="payment_type" value="cc"/>');
    } else {
