...
function paypalSelectedCheck() 
{
            ...
            var status = $('input[name=appointment_status]').val();
            ...
            console.log('paypalCheck oid:'+oid+' payment_type:'+choice+' appointment_status:'+status+' payment_status:'+payment);
...
{           
            if(paypalSelectedCheck())
            {
               ...
               /* */
                ...
                $.getScript( "/appointments/paypal/getToken?oid="+oid, 
                        function(){ 
                                ...
                                braintree.setup(paypal_token, 'custom', {
                                    ...
                                    onPaymentMethodReceived: function (obj) {
                                       /* client has paid */
                                        ...
                                        var url = '/appointments/paypal/sendNonce?nonce='+obj.nonce+'&oid='+oid+'&amount='+amount+'&slug='+slug;
                                        $.ajax({url: url}).done(function( data ) {
                                                            ...
                                                            /* save appointment again with info */
...
//                                                    );
                                    ...
                                    onError: function(type, message) {
                                        ...
                                        $('input[name=log]').val('Paypal error\n'+type+'\n'+message+'\n'+$('input[name=log]').val());
                                                           $('#appointment-form form').submit();
                                        //$.getScript("/appointments/paypal/log?oid="+oid);
                                    }
                              });
                });
            } else {
